            ...
            <nav className="relative flex flex-wrap items-center justify-between px-2 py-3 bg-white mb-3">
                <div className="w-full px-4 mx-auto flex flex-wrap lg:flex-row-reverse items-center justify-between">
                    ...
                    >
                            ...
                            {Routes.map((item) => (
                                <li className="nav-item group/nav" key={item.name}>
                                    <a
                                        ...
                                        href={item.route}
                                    >
                                        <span className="group-hover/nav:border-b-2 group-hover/nav:border-primary-500 group-hover/nav:text-primary-500 border-b-2 border-transparent">
                                            {item.label}
                                        </span>
                                    </a>
                                </li>
                        ...
                        <CustomButton icon={<>Icon</>} type="primary">
